package id.kakzaki.blue_thermal_printer.printer;
...
import id.kakzaki.blue_thermal_printer.Utils;
...
/** PrinterPlugin */
public class PrinterPlugin implements FlutterPlugin, MethodCallHandler,ActivityAware, RequestPermissionsResultListener  {
